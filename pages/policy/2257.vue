<template>
  <div class="tag">
    ...
    <div class="police">
      <div class="police-title">18 U.S.C. §2257 Record Keeping Requirements Compliance Statement.</div>
      <div class="police-text-content">
        The operator of nottyhub is not the producer (whether primary or secondary as defined in 18 U.S.C. § 2257) of any of the content found on nottyhub. The operator’s activities, with respect to such content, are limited to the transmission, storage, retrieval, hosting and/or formatting of depictions posted by third party users, on areas of the website under the user's control.
      </div>
