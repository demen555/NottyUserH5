<template>
  <div class="tag">
    ...
    <Nav title="EU DSA" text></Nav>
    <div class="police">
      <div class="police-title">EU Digital Services Act</div>
      <div class="police-title-text">As of July 31, 2023</div>
      <div class="police-text-content-prev">
        Nottyhub has 33 million average monthly recipients of the service in the European Union, calculated as an average over the period of the past six months.
      </div>
    </div>
  </div>
</template>
