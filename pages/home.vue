        ...
        <div class="home-footer">
          ...
          <div class="home-footer-icon">
            ...
            <div>
              ...
              <a href=" https://www.youtube.com/@NottyHub X.com"><img class="common" :src="themeChecked? require('~/static/images/youtube_1.svg'): require('~/static/images/rat-1.png')" alt="rta"></a>
